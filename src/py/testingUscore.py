...
eval_labels=["Endings","Hash-Tags","Trigrams","Unigrams","Bigrams","Stems","Summed Scores with Variances","Summed Scores"]
TestingScoreList=[t_EndingScores,t_HashScores,t_TrigramScores,t_UnigramScores,t_BigramScores,t_StemScores,TestScores,TestScores2]

TrainingScoreList=[EndingScores,HashScores,TrigramScores,UnigramScores,BigramScores,StemScores,UserScores,UserScores2]
