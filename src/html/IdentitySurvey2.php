...
<head>
	...
	<script src="core/IdentitySurvey2.js" type="text/javascript"></script>
...
-->    
				...
				<span style="margin-left:10px;"><a href="https://twitter.com/share" class="twitter-share-button"
					...
					data-url='http://smallsocialsystems.com/groupid/AboutUs.php?flag=<?php echo encode_salt($_SESSION["twitid"]);?>+'
