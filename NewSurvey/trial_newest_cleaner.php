...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="core/images/idproj.ico" />
	...
	<link rel='stylesheet' type='text/css' href="core_each/css/bootstrap.min.css">
	<link rel='stylesheet' type='text/css' href="core_each/jumbotron-narrow.css">
</head>
...
<body bgcolor="#F5F3EF">
	...
	<div class="header"> 
		...
		<img src="core/images/Aspects_Cover.png" alt="Self-Aspects Study"></span>
	</div>
...
<div id= "full-saspect" class="wrapper">
	...
	<input type=button id ="aspect_instruct_button" value= "Instructions" />
	...
	<div class="right-col" id="right_side">
		...
		<input type=reset id ="add_group" value= "Add Self-Aspect" onclick="add_group_click();"/>
